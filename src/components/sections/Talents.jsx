...
export default function Talents() {
  return (
    ...
    >
      <div className="pointer-events-none absolute left-0 top-0 flex h-full w-full items-center justify-center opacity-20 animate-spin-slow">
        <svg
          viewBox="0 0 200 200"
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          ...
          <p className="mx-auto mb-12 max-w-2xl text-[#888888]">
            Buscamos estudantes apaixonados por tecnologia, robótica e desafios. Se
            você estuda na UFSM e quer colocar a mão na massa em projetos reais,
